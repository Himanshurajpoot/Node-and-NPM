...
var chunkd = lodash.chunk(characters, 2);
console.log(chunkd);
var mix = [0, 1, false, 2, '', 3];
var compact = lodash.compact(mix);
console.log(compact);
var array = [1, 2];
var concat = lodash.concat(array, 3, [4], [[5]], [6]);
console.log(concat);
console.log(lodash.difference([2, 1], [2, 3]));
var drop = lodash.drop(characters, 2);
console.log(drop);
var dropRight = lodash.dropRight(characters, 2);
